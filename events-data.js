...
{
  "title": "Situación 18: Pensamiento A3 ante cuasiincidentes de medicación",
  "area": "SALA DE INTERNACIÓN",
  "time": "🕒 06:00 AM",
  "context": "En una unidad de internación se detectaron cuatro cuasiincidentes por administración de medicación al paciente equivocado durante el último mes. El jefe propone capacitar nuevamente al personal. ¿Cuál debería ser el primer paso según el pensamiento A3?",
  "tool": "Pensamiento A3 (Lean Healthcare)",
  "opts": [
    {
      "txt": "Capacitar de inmediato a todo el personal sobre identificación segura.",
      "ok": false,
      "risk": 20,
      "comm": -10,
      "lean": -15,
      "fb": "⚠️ Capacitar sin analizar antes el proceso actual es una solución prematura que puede no atacar la causa real.",
      "debrief": "El A3 exige primero comprender el problema con datos; saltar a una solución sin ese análisis arriesga resolver el síntoma equivocado."
    },
    {
      "txt": "Describir el proceso actual y reunir datos de los cuasiincidentes.",
      "ok": true,
      "risk": 0,
      "comm": 10,
      "lean": 20,
      "fb": "✅ Correcto. El pensamiento A3 comienza siempre por describir la situación actual y recolectar datos antes de proponer soluciones.",
      "debrief": "El pensamiento A3 sigue una secuencia estructurada (contexto, situación actual, análisis de causa raíz, contramedidas, plan, seguimiento); el primer paso es siempre describir el proceso vigente y reunir datos objetivos, no saltar directamente a una acción correctiva."
    },
    {
      "txt": "Sancionar a quienes participaron en los errores de administración.",
      "ok": false,
      "risk": 30,
      "comm": -20,
      "lean": -15,
      "fb": "❌ Un enfoque punitivo contradice el análisis sistémico del A3 y desalienta el reporte futuro de cuasiincidentes.",
      "debrief": "El A3, como las herramientas de mejora continua, analiza el proceso y el sistema, no busca culpables individuales."
    },
    {
      "txt": "Reemplazar el sistema de medicación sin analizar el proceso vigente.",
      "ok": false,
      "risk": 25,
      "comm": -15,
      "lean": -15,
      "fb": "❌ Cambiar el sistema sin haber analizado el proceso actual puede introducir nuevos riesgos no identificados.",
      "debrief": "Ninguna contramedida del A3 se define antes de completar el análisis del estado actual y la causa raíz del problema."
    }
  ]
},
{
  "title": "Situación 19: Gemba y causa raíz en la identificación con pulseras",
  "area": "ADMISIÓN - GESTIÓN DE PROCESOS",
  "time": "🕒 06:45 AM",
  "context": "Durante la observación en el gemba, el equipo comprueba que las pulseras se imprimen lejos del área de admisión y suelen acumularse antes de colocarse. ¿Cuál interpretación es más adecuada para el A3?",
  "tool": "Gemba / Análisis de Causa Raíz (Lean Healthcare)",
  "opts": [
    {
      "txt": "El personal demuestra escaso compromiso con la seguridad institucional.",
      "ok": false,
      "risk": 25,
      "comm": -15,
      "lean": -10,
      "fb": "❌ Atribuir el problema al compromiso individual ignora la evidencia observada en el gemba: es el diseño del flujo el que genera la acumulación.",
      "debrief": "El pensamiento Lean evita explicaciones basadas en la actitud del personal cuando la observación directa señala una causa de proceso."
    },
    {
      "txt": "La causa principal es la falta de atención del admisor.",
      "ok": false,
      "risk": 25,
      "comm": -15,
      "lean": -10,
      "fb": "❌ Culpar a la atención individual no explica por qué las pulseras se acumulan por la distancia entre la impresora y el puesto de admisión.",
      "debrief": "El gemba mostró una causa estructural (distancia física, diseño del flujo), no una falla de atención personal."
    },
    {
      "txt": "El diseño del flujo favorece acumulaciones y errores de identificación.",
      "ok": true,
      "risk": 0,
      "comm": 10,
      "lean": 20,
      "fb": "✅ Correcto. La observación en el gemba muestra que la distancia entre la impresora y la admisión genera la acumulación que favorece los errores.",
      "debrief": "El gemba (ir al lugar real donde ocurre el trabajo) permite identificar causas de proceso, como el diseño físico del flujo, en lugar de atribuir el problema a la conducta individual."
    },
    {
      "txt": "Los pacientes deberían controlar siempre sus propias pulseras identificatorias.",
      "ok": false,
      "risk": 30,
      "comm": -20,
      "lean": -15,
      "fb": "❌ Trasladar la responsabilidad de la identificación segura al paciente no corrige la causa de proceso detectada en el gemba.",
      "debrief": "La verificación de identidad es una responsabilidad del sistema y del equipo de salud, no puede delegarse al paciente como solución de fondo."
    }
  ]
},
{
  "title": "Situación 20: Implementar la contramedida del A3",
  "area": "ADMISIÓN - GESTIÓN DE PROCESOS",
  "time": "🕒 07:00 AM",
  "context": "El equipo propone acercar la impresora al puesto de admisión y colocar la pulsera inmediatamente después de validar dos identificadores. ¿Cuál es la mejor forma de implementar esta contramedida?",
  "tool": "Pensamiento A3 (Lean Healthcare)",
  "opts": [
    {
      "txt": "Aplicarla en todo el hospital y evaluar resultados al finalizar el año.",
      "ok": false,
      "risk": 20,
      "comm": -10,
      "lean": -15,
      "fb": "⚠️ Escalar a todo el hospital sin una prueba piloto previa expone a un cambio no validado y retrasa un año la corrección de errores no previstos.",
      "debrief": "El A3 recomienda validar contramedidas a pequeña escala antes de una implementación institucional completa."
    },
    {
      "txt": "Probarla en un turno y medir errores, tiempos y cumplimiento.",
      "ok": true,
      "risk": 0,
      "comm": 10,
      "lean": 20,
      "fb": "✅ Correcto. Un piloto acotado con datos de seguimiento permite validar la contramedida antes de escalarla.",
      "debrief": "El ciclo del pensamiento A3 (plan-do-check-act) exige probar la contramedida en una escala pequeña y medir su efecto real antes de extenderla, ajustando lo necesario según los datos obtenidos."
    },
    {
      "txt": "Implementarla únicamente cuando ocurra un nuevo incidente de identificación.",
      "ok": false,
      "risk": 30,
      "comm": -20,
      "lean": -15,
      "fb": "❌ Esperar a un nuevo incidente para actuar contradice el enfoque preventivo del A3, que ya identificó la causa raíz.",
      "debrief": "Una vez identificada la causa raíz y diseñada la contramedida, el A3 exige actuar de forma proactiva, no esperar a que el riesgo se materialice de nuevo."
    },
    {
      "txt": "Mantener el proceso actual y reforzar recordatorios visuales al personal.",
      "ok": false,
      "risk": 25,
      "comm": -15,
      "lean": -15,
      "fb": "⚠️ Reforzar recordatorios no corrige la causa raíz identificada (la distancia física entre impresora y admisión).",
      "debrief": "Un recordatorio visual es una medida débil frente a una causa de diseño de proceso; el A3 busca rediseñar el flujo, no solo reforzar la atención humana."
    }
  ]
}
];
